...
const CreatePoint = () => {
    ...
    }, []) For some reason, this useEffect() does nothing on some machines. */
    ...
    useEffect(() => {
        // Load cities based on chosen UF
        if (selectedUf === '0') {
            return;
        }
    ...
    function handleInputChange(event: ChangeEvent<HTMLInputElement>) {
        ...
        /**
         * In the setFormData call below, I used a spread operator ..., to
    ...
    async function handleSubmit(event: FormEvent) {
        event.preventDefault(); /* Prevents page reloading or redirecting */
